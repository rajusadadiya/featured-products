...
class FeaturedProduct extends \RS\FeaturedProducts\Block\AbstractFeaturedProduct
{
    ...
    public function getProductDetailsHtml(\Magento\Catalog\Model\Product $product)
    {
        ...
        if ($renderer instanceof \Magento\Swatches\Block\Product\Renderer\Listing\Configurable && $versionPart[1] == 3 && $versionPart[2] > 2) {
            $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
            $configurableViewModelObj = $objectManager->create('Magento\Swatches\ViewModel\Product\Renderer\Configurable');
